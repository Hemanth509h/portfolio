...
const Carousel = React.forwardRef(({
  ...
  return <CarouselContext.Provider value={{
    ...
    canScrollPrev,
    canScrollNext
  }}><div ref={ref} onKeyDownCapture={handleKeyDown} className={cn("relative", className)} role="region" aria:roledescription="carousel" {...props}>{children}</div></CarouselContext.Provider>;
});
