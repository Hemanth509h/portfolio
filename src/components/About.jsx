...
const strengths = [
  { icon, title: "Problem Solver", desc: "Breaking down complex challenges into clean, maintainable solutions." },
  { icon, title: "Team Player", desc: "Thriving in collaborative environments with clear communication." },
  { icon, title: "Fast Learner", desc: "Quickly adopting new technologies and best practices." },
];
