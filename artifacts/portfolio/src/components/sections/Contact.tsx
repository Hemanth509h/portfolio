            ...
            <div className="glass-panel p-8 rounded-3xl h-full flex flex-col justify-between">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <div>
                      ...
                      <a href="mailto:alex@example.com" className="text-base">alex@example.com</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 text-muted-foreground hover:text-foreground transition-colors">
                    <div className="p-3 bg-white/5 rounded-xl border border-white/10">
              ...
              <div className="mt-12 pt-8 border-t border-white/10">
                ...
                <div className="flex gap-4">
                  <a href="#" className="p-3 bg-white/5 rounded-xl border border-white/10 text-muted-foreground hover:text-primary hover:border-primary/50 transition-all group">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="How can I help you?" className="min-h-[160px]" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
