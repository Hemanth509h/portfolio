    ...
    <section id="experience" className="py-24 relative bg-white/[0.02]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative pl-8 md:pl-0">
          {/* Timeline central line for desktop, left line for mobile */}
            ...
            {EXPERIENCES.map((exp, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div className={`w-full md:w-1/2 ${isEven ? 'md:pl-16' : 'md:pr-16'} pl-12 md:pl-0`}>
                    <div className="glass-panel p-8 rounded-3xl hover:border-primary/30 transition-colors">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                        <h4 className="text-xl font-display font-bold text-foreground">{exp.role}</h4>
                      ...
                      <h5 className="text-lg font-medium text-muted-foreground mb-4">{exp.company}</h5>
